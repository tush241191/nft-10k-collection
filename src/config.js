...
const namePrefix = 'Gaia comic';
const description = 'Gaia comic collection';
...
// NFTPort Info
// ** REQUIRED **
const AUTH = 'e8d22e1d-8193-4f03-97cd-75cc6f95be0c';
const LIMIT = 2; // Your API key rate limit
const CONTRACT_NAME = 'Gaia Comic';
const CONTRACT_SYMBOL = 'GAIA';
const CONTRACT_TYPE = 'erc721';
const MINT_TO_ADDRESS = '0xBF84162Bd049b63c64a83bd51aB8CdBaca9e6C9a';
const CHAIN = 'rinkeby';
...
// ** OPTIONAL **
let CONTRACT_ADDRESS = '0x89414129e954F5137ee19F20B671688886696834'; // If you want to manually include it
